...
wall-of-text-more-desktop = Endi ochiq ma’lumotlar bazasini shakllantirish uchun o‘z ovozingiz bilan hissa qo‘shishingiz mumkin. Bundan barcha innovatsion qurilma, ilova va veb dasturlarni yaratishda foydalana oladi. Mashina inson nutqini o‘rganishi uchun gaplarni o‘qib bering. Sifatni oshirish uchun esa o‘qilgan gaplarni tekshiring. Hammasi juda oddiy!
wall-of-text-first = Ovoz — tabiiy va insoniy. Sun’iy ongga mos ovoz texnologiyasini ishlab chiqish esa juda quvonarli. Lekin bunday tizimlarni tuzish uchun o‘ta katta hajmdagi ovozli ma’lumotlar kerak bo’ladi.
wall-of-text-second = Gigant kompaniyalar foydalanadigan ma’lumotlarning aksari hamma uchun ham ochiq emas. Fikrimizcha, bu porloq innovatsiyalar rivojini so‘ndiradi. Shu sababdan biz hamma uchun ochiq va bepul ovozni aniqlash loyihasi — Common Voice'ni ishga tushirdik.
...
faq-do-want-native-q = Ushbu til mening ona tilim boʻlmaganligi uchun lahja bilan gapiraman. Mening ovozim sizlarga asqatadimi?
...
datasets-headline = Biz ochiq va hammaga ruxsat berilgan ovoz ma’lumotlari jamlanmalarini tuzdik.  Xohlagan kishi ovozli o‘qish ruxsat berilgan dasturlarga o‘rgatish uchun undan foydalanishi mumkin.
datasets-positioning =
    Ishonchimiz komilki, keng ommaga taqdim etiladigan ovozli ma'lumotlar to'plami innovatsiyalar va avtomatlashtirilgan nutq texnologiyasida sog'lom tijorat raqobatiga yordam beradi.
    
    Common Voice-ning ko'p tilli ma'lumotlar to'plami allaqachon ushbu turdagi eng ommabop ovozli ma'lumotlar to'plamidir, ammo bu yagona emas.
    
    Ushbu sahifani boshqa ochiq manbali ovozli ma'lumotlar to'plamlari uchun ma'lumotnoma markazi sifatida ko'ring va Common Voice o'sishda davom etib, bizning yangilanishlarimiz uchun uy.
language = Til
...
why-email = <b> Nega elektron pochta? </b> kelajakda biz ma'lumotlar bazasidagi o'zgarishlar to'g'risida siz bilan bog'lanishimiz kerak bo'lishi mumkin, elektron pochta orqali biz bilan bog'lanish joyi ko'rsatilgan.
confirm-size = Siz ni yuklab olishga tayyormiz
size-gigabyte = GB
size-megabyte = MB
confirm-no-identify = Umumiy ovoz ma'lumotlar bazasidagi dinamiklarning "kimligini" aniqlay olmayman degani nimani anglatadi?
download-language = { $language }ni yuklash
validated-hours = Tekshilgan soatlar miqdori
recorded-hours = Jami yozilgan soatlar
whats-inside = Common Voice maʼlumotlar bazasidan nimalar joy olgan?
dataset-description-hours =
    Ma'lumotlar bazasidagi har bir yozuv noyob MP3 va tegishli matnli fayldan iborat. Ma'lumotlar to'plamidagi yozib olingan  soatlarning aksariyati, yoshi, jinsi va urg'u kabi demografik meta-ma'lumotlarini o'z ichiga oladi, bu nutqni aniqlash vositalarining aniqligini o'rgatishga yordam beradi.
    
    Hozirgi vaqtda ma'lumotlar to'plami  tillarida tasdiqlangan soatdan iborat, ammo biz har doim ko'proq ovoz va tillarni qo'shmoqdamiz. Tilni so'rash yoki o'z hissasini qo'shishni boshlash uchun bizning Languages sahifamiz -ni ko'rib chiqing.
want-dataset-update = Umumiy ovozli ma'lumotlar to'plamining yangi versiyasini chiqqanda yangilanishlarni xohlaysizmi? Bizning yangiliklarimizga obuna bo'ling.
...
listen-instruction = { $actionType }<playIcon></playIcon> jumlalar to‘g‘ri talaffuz qilinganmi?
...
report-grammar-or-spelling = Grammatik / imlo xatosi
report-grammar-or-spelling-detail = Jumlada grammatik yoki imlo xatosi mavjud.
report-different-language = Boshqa tillar
report-different-language-detail = Bu men gapirayotganimdan boshqa tilda yozilgan.
report-difficult-pronounce = Talaffuz qilish qiyin
report-difficult-pronounce-detail = Unda o'qish yoki talaffuz qilish qiyin bo'lgan so'zlar yoki iboralar mavjud.
report-offensive-speech = Haqoratli nutq
report-offensive-speech-detail = Klipda hurmatsizlik yoki haqoratomuz so'zlar mavjud.
report-other-comment =
    .placeholder = Izoh
success = Tayyor!
continue = Davom etish
report-success = Hisobot muvaffaqiyatli qabul qilindi
...
daily-goal-created = Sizning kunlik maqsadingiz yaratildi
track-progress = Jarayonni bu erda va statistika sahifangizda kuzatib boring.
return-to-edit-goal = Istalgan vaqtda tahrirlash uchun bu erga qayting.
share-goal = Maqsadimni baham ko'ring

## Profile Delete

delete-q = Ovoz yozuvlaringizni ham o'chirib tashlashni so'ramoqchimisiz yoki ularni Umumiy ovozli ma'lumotlar to'plamida saqlashni xohlaysizmi?
keep = Saqlash
remove = Olib tashlash
keep-info = Sizning anonim ovoz yozuvlaringiz Umumiy ovoz ma'lumotlar bazasida qoladi. O'z profilingizni yo'q qilganingizdan so'ng, yozuvlaringizni ma'lumotlar bazasidan olib tashlash to'g'risida so'rov yuborolmaysiz
remove-info = Ovoz yozuvlaringizni ma'lumotlar bazasidan olib tashlash bo'yicha so'rovingizni ko'rib chiqamiz. Agar sizning so'rovingiz ma'qullangan bo'lsa, biz ma'lumotlar to'plamini yuklab olganlar bilan bog'lanamiz va sizning ovoz yozuvlaringizni ham o'chirib tashlashlarini so'raymiz.
why-delete-recordings =
    Umumiy ovoz yozuvlari akademiklar, kichik korxonalar va ovozni aniqlash tarafdorlari tomonidan ovozli modellar kabi ommabop manbalarni tayyorlash va o'stirishga yordam beradi.
...
help-contribute = Umumiy ovozli profil yaratish va ovozingizga hissa qo'shish orqali siz turli xil, ochiq manbali ma'lumotlar bazasini yaratishda yordam berishingiz mumkin.
